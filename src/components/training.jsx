...
const Training = () => {
    return (
        <section>
            <div class="sc-92373a90-0 sc-24635258-3 hUMDcf kXMeHm"></div>
                ...
                <div className="sc-115b9aa5-0 duvreu">
                    ...
                    <div className="sc-92373a90-0 jDasLf" style={{ display: "flex" }}>
                        ...
                        <div className="sc-7267286d-0 THEFD" style={{ width: "100%" }}>
                            <div className="sc-7267286d-0 jnzbPz sc-697adae-0 ffIBxc">
                                <img
                                    alt="AECOM"
                                    loading="lazy"
                                    width="90"
                    ...
                    <div className="sc-115b9aa5-0 eMOtyj sc-16245d71-1 bfdMuT">
                        <div className="sc-68483de-0 iENhdk">
                            <div className="sc-7267286d-0 dRRMjY sc-16245d71-0 gRxBiS">
                                ...
                                <div className="sc-92373a90-0 sc-bda8e52b-0 hUMDcf enBCuL">
                                    <div className="sc-92373a90-0 hVecjm" style={{ width: 48, height: 48 }}>
                                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="white" varient="scaled" name="svg" class="sc-42e4aaa8-0 kOcPjY"><path d="M10.0591 8.33332V15.2448C10.0591 15.7083 10.6195 15.9405 10.9472 15.6127L14.393 12.1669C14.5958 11.9642 14.5962 11.6356 14.3941 11.4322L10.9483 7.9665C10.621 7.6373 10.0591 7.86909 10.0591 8.33332Z" fill="#5925DC"></path><path d="M19.3807 20.1048H4.29586C3.89617 20.1048 3.57275 19.7813 3.57275 19.3817V4.2961C3.57275 3.89642 3.89617 3.573 4.29586 3.573H19.3807C19.7804 3.573 20.1038 3.89642 20.1038 4.2961V19.3817C20.1038 19.7813 19.7804 20.1048 19.3807 20.1048ZM5.01896 18.6586H18.6576V5.0192H5.01896V18.6586Z" fill="#5925DC"></path></svg>
                                    </div>
                                    <div className="sc-92373a90-0 kjYnTS" style={{ width: 48, height: 48 }}>
                                        {/* SVG Icon 4 */}
                                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#53389e" varient="scaled" name="svg" class="sc-42e4aaa8-0 jYKPph"><path d="M10.0591 8.33332V15.2448C10.0591 15.7083 10.6195 15.9405 10.9472 15.6127L14.393 12.1669C14.5958 11.9642 14.5962 11.6356 14.3941 11.4322L10.9483 7.9665C10.621 7.6373 10.0591 7.86909 10.0591 8.33332Z" fill="#5925DC"></path><path d="M19.3807 20.1048H4.29586C3.89617 20.1048 3.57275 19.7813 3.57275 19.3817V4.2961C3.57275 3.89642 3.89617 3.573 4.29586 3.573H19.3807C19.7804 3.573 20.1038 3.89642 20.1038 4.2961V19.3817C20.1038 19.7813 19.7804 20.1048 19.3807 20.1048ZM5.01896 18.6586H18.6576V5.0192H5.01896V18.6586Z" fill="#5925DC"></path></svg>
                                    </div>
                                    <div className="sc-92373a90-0 hUMDcf" style={{ padding: "0px 8px" }}>
                                        <h5 className="sc-d80c85c8-0 jFiFRu">
                                ...
                                <div className="keen-slider" style={{ width: "100%" }}>
                                    ...
                                    <div className="sc-92373a90-0 sc-c506afef-0 hUMDcf eLLkAw keen-slider__slide relative" style={{ minWidth: 497.337, maxWidth: 497.337, transform: "translate3d(0px, 0px, 0px)" }}>
                                        <img
                                            ...
                                            data-nimg="fill"
                                            sizes="100vw"
                                            src="https://www.novatr.com/nextImageExportOptimizer/oneistox-assets.s3.ap-south-1.amazonaws.com_images-v2_home_learning_2-opt-1520.WEBP"
                                            style={{ position: "absolute", height: "100%", width: "100%", inset: 0, objectFit: "cover", color: "transparent" }}
                                        />
                                    </div>
                                </div>
                                <div className="sc-7267286d-0 biwMBn" style={{ width: "100%", gap: 4 }}>
                                    <div className="sc-c506afef-1 hBovez"></div>
                                    <div className="sc-c506afef-1 gMGKWe"></div>
                                </div>
                            </div>
                        </div>
                    </div>
